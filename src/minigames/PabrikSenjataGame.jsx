...
const QUESTIONS = [
  { expr: '(−3) × 4', answer: -12, min: -20, max: 20 },
  { expr: '(−5) × (−3)', answer: 15, min: -20, max: 20 },
  { expr: '6 × (−7)', answer: -42, min: -50, max: 10 },
  { expr: '(−8) × (−4)', answer: 32, min: 0, max: 50 },
  { expr: '(−20) ÷ 4', answer: -5, min: -15, max: 5 },
  { expr: '(−18) ÷ (−6)', answer: 3, min: -5, max: 10 },
  { expr: '24 ÷ (−8)', answer: -3, min: -10, max: 5 },
  { expr: '(−36) ÷ (−9)', answer: 4, min: -5, max: 10 },
  { expr: '(−4) × 5 × (−2)', answer: 40, min: -50, max: 50 },
  { expr: '(−3) × (−3) × (−1)', answer: -9, min: -20, max: 10 },
]
...
export default function PabrikRobotGame({ goBack }) {
  ...
  const newQ = useCallback(() => { setQ(genQ()); setSelected(0); setFeedback(null) }, [])
