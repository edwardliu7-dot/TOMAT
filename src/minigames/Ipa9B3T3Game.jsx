...
const ACCENT = '#1d4ed8'
const BG = 'linear-gradient(180deg, #020c1a 0%, #041830 100%)'
const TITLE = '🏥 Reproductive Health Guardian'
...
export default function Ipa9B3T3Game({ onBack }) {
      ...
      <div style={{ flex: 1, padding: '16px 20px', display: 'flex', flexDirection: 'column', gap: 16, maxWidth: 600, margin: '0 auto', width: '100%' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          {q.choices.map((c, i) => {
            ...
            if (selected !== null) {
              if (c === q.benar) { bg = '#1d4ed820'; border = '1.5px solid #1d4ed8'; color = '#93c5fd' }
