...
const ACCENT = '#15803d'
const BG = 'linear-gradient(180deg, #021008 0%, #031a0a 100%)'
const TITLE = '🌱 Flora & Fauna Breeder'
...
export default function Ipa9B3T4Game({ onBack }) {
      ...
      <div style={{ flex: 1, padding: '16px 20px', display: 'flex', flexDirection: 'column', gap: 16, maxWidth: 600, margin: '0 auto', width: '100%' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          {q.choices.map((c, i) => {
            ...
            if (selected !== null) {
              if (c === q.benar) { bg = '#15803d20'; border = '1.5px solid #15803d'; color = '#86efac' }
