...
const ACCENT = '#c2410c'
const BG = 'linear-gradient(180deg, #180500 0%, #280c00 100%)'
const TITLE = '📊 Consequence Analyzer'
...
export default function Ipa9B2T5Game({ onBack }) {
      ...
      <div style={{ flex: 1, padding: '16px 20px', display: 'flex', flexDirection: 'column', gap: 16, maxWidth: 600, margin: '0 auto', width: '100%' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          {q.choices.map((c, i) => {
            ...
            if (selected !== null) {
              if (c === q.benar) { bg = '#c2410c20'; border = '1.5px solid #c2410c'; color = '#fdba74' }
