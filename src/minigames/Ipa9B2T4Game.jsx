...
const ACCENT = '#9f1239'
const BG = 'linear-gradient(180deg, #100008 0%, #1c0010 100%)'
const TITLE = '🃏 Substance Flashcards'
...
export default function Ipa9B2T4Game({ onBack }) {
      ...
      <div style={{ flex: 1, padding: '16px 20px', display: 'flex', flexDirection: 'column', gap: 16, maxWidth: 600, margin: '0 auto', width: '100%' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          {q.choices.map((c, i) => {
            ...
            if (selected !== null) {
              if (c === q.benar) { bg = '#9f123920'; border = '1.5px solid #9f1239'; color = '#fda4af' }
