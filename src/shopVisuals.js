...
export const BINGKAI_VISUALS = {
  ...
  bingkai_aurum_sovereign: { border: '#D4AF37', style: 'double', glow: true },
  bingkai_void_monarch: { border: '#6366F1', style: 'solid', glow: true },
}
...
export const SPANDUK_VISUALS = {
  ...
  spanduk_celestia_relic: { gradient: 'linear-gradient(115deg,#020617,#172554 48%,#e0f2fe)' },
  spanduk_royal_mathematician: { gradient: 'linear-gradient(115deg,#17120c,#45351b 48%,#d4af37)' },
}
